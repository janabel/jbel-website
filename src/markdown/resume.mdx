...
- **Languages/Libaries**: Python (NumPy, Matpotlib), TypeScript/JavaScript, HTML/CSS, Circom
- **Software/Libraries**: Jupyter Notebook, SageMath, GitHub
- **Developer Tools**: Git, React, Parcel, Vite, Vercel
