...
- **Urban Studies and Sociology**: Land Use Law and Politics\*, Writing About Race, Intro to Political Philosophy, Intro to Housing, Community and Economic Development
...
- **0xPARC Foundation**, Research and Development
  _July 2024, August 2024_, San Francisco

  - Wrote blog posts to distill hard mathematical concepts into a form accessible to technical generalists. Developed interactive educational demos for key cryptographic primitives. Developed a zero-knowledge based application to be used at DevConnect 2024.
...
- **Languages**: Python, TypeScript/JavaScript, HTML/CSS, Circom
- **Software/Libraries**: Jupyter Notebook, SageMath, Git, NumPy
