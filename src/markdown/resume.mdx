...
**Phone:** 617-480-9158 | **Email:** [janabel@mit.edu](mailto:janabel@mit.edu) | **LinkedIn:** [linkedin.com/in/janabel-xia](https://www.linkedin.com/in/janabel-xia-21099711a) | **GitHub:** [github.com/janabel](https://github.com/janabel)
...
- **Urban Studies and Sociology**: Land Use Law and Politics\*, Writing About Race, Intro Political Philosophy, Intro to Housing, Community and Economic Development
...
- **Janabel Xia**, _Deterministic Stack-Sorting for Set Partitions_, (2023), [arxiv:2309.14644](http://arxiv.org/abs/2309.14644) (accepted and to be published in April in [Enumerative Combinatorics and Applications](https://ecajournal.kms-ks.org/))
...
- **Judy Hsin-Hui Chiang, Anh Trong Nam Hoang, Matthew Kendall, Ryan Lynch, Son Nguyen, Benjamin Przybocki, and Janabel Xia**, _Bender-Knuth involutions on linear extensions of posets_, (2023), [arXiv:2302.12425](https://doi.org/10.48550/arXiv.2302.12425) (submitted to [Discrete Mathematics](https://www.sciencedirect.com/journal/discrete-mathematics))
...
- **UMN Duluth Combinatorics REU**, National Science Foundation, Research Experience for Undergraduates (REU), University of Minnesota Duluth  
...
- **MIT Resilient Infrastructure Networks Lab**, MIT Department of Civil and Environmental Engineering  
  _February 2023 -- June 2023_

  - Conducted research under PhD student Aron Brenner and Professor Saurabh Amin. Investigated graphical models in machine learning for traffic flow forecasting and user mode-choice prediction, particularly in incident settings. [Code](https://github.com/janabel/flow_prediction/tree/master).
...
- **UMN Twin Cities Combinatorics and Algebra REU**, National Science Foundation, Research Experience for Undergraduates (REU), University of Minnesota Twin Cities  
  ...
  - Conducted combinatorics research on simultaneous core partitions and group actions on linear extensions, resulting in two publications listed above. Tested conjectures with Python using SageMath software.
...
- **Mathematical Olympiad Program Teaching Assistant**, Mathematical Association of America  
  _June 2021, June 2022_, Carnegie Mellon University
...
- **Mathematical Olympiad Program Residential Assistant**, Mathematical Association of America  
  _July 2020_, (Remote)
...
- **MIT Asian Dance Team (ADT)**  
  ...
  _Director of Public Relations, Head Choreographer, Choreographer_  
  MIT
...
- **WebAuthn zk-SNARK Verification**  
  _March 2023 - April 2023_

  - Worked on initial adaptations of ECDSA zkSNARK circuits to the secp256r1 elliptic curve in the Circom programming language, which can be used in verifying Web Authentication for account abstraction. [GitHub](https://github.com/janabel/circom-ecdsa-p256).
...
- **VHLApp Android Mobile App**  
  _January 2021_
  - Coded app from scratch in Java for healthcare nonprofit VHL Alliance. App allows users to access medical information and organize medical contacts. Used the Backendless API and database platform.
